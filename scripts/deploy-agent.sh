...
GOOGLE_CLIENT_ID_PARAM_VALUE="${GOOGLE_CLIENT_ID_PARAM:-/friday/agent/gmail-client-id}"
GOOGLE_CLIENT_SECRET_PARAM_VALUE="${GOOGLE_CLIENT_SECRET_PARAM:-/friday/agent/gmail-client-secret}"
GOOGLE_REFRESH_TOKEN_PARAM_VALUE="${GOOGLE_REFRESH_TOKEN_PARAM:-/friday/agent/gmail-refresh-token}"
GMAIL_PUBSUB_VERIFICATION_TOKEN_PARAM_VALUE="${GMAIL_PUBSUB_VERIFICATION_TOKEN_PARAM:-/friday/agent/gmail-pubsub-verification-token}"
DASHBOARD_SESSION_SECRET_PARAM_VALUE="${DASHBOARD_SESSION_SECRET_PARAM:-/friday/agent/dashboard-session-secret}"
...
TELEGRAM_BOT_USERNAME_VALUE="${TELEGRAM_BOT_USERNAME:-}"
...
GMAIL_PUBSUB_TOPIC_NAME_VALUE="${GMAIL_PUBSUB_TOPIC_NAME:-}"
GMAIL_WATCH_LABEL_IDS_VALUE="${GMAIL_WATCH_LABEL_IDS:-INBOX}"
GMAIL_WATCH_LABEL_FILTER_ACTION_VALUE="${GMAIL_WATCH_LABEL_FILTER_ACTION:-include}"
GMAIL_WATCH_RENEWAL_DAYS_VALUE="${GMAIL_WATCH_RENEWAL_DAYS:-5}"
DASHBOARD_SESSION_TTL_SECONDS_VALUE="${DASHBOARD_SESSION_TTL_SECONDS:-86400}"
...
if [[ -z "$stack_status" ]]; then
  common_parameters=(
    ...
    "GmailPubsubTopicName=${GMAIL_PUBSUB_TOPIC_NAME_VALUE}"
    "GmailWatchLabelIds=${GMAIL_WATCH_LABEL_IDS_VALUE}"
    "GmailWatchLabelFilterAction=${GMAIL_WATCH_LABEL_FILTER_ACTION_VALUE}"
    "GmailWatchRenewalDays=${GMAIL_WATCH_RENEWAL_DAYS_VALUE}"
    "DashboardSessionTtlSeconds=${DASHBOARD_SESSION_TTL_SECONDS_VALUE}"
    ...
    "GoogleClientIdParam=${GOOGLE_CLIENT_ID_PARAM_VALUE}"
    "GoogleClientSecretParam=${GOOGLE_CLIENT_SECRET_PARAM_VALUE}"
    "GoogleRefreshTokenParam=${GOOGLE_REFRESH_TOKEN_PARAM_VALUE}"
    "GmailPubsubVerificationTokenParam=${GMAIL_PUBSUB_VERIFICATION_TOKEN_PARAM_VALUE}"
    "DashboardSessionSecretParam=${DASHBOARD_SESSION_SECRET_PARAM_VALUE}"
    ...
    "TelegramBotUsername=${TELEGRAM_BOT_USERNAME_VALUE}"
