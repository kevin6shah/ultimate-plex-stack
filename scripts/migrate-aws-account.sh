...
stack_parameters=(
  ...
  ParameterKey=EnableTemporalIngress,ParameterValue="$ENABLE_TEMPORAL_INGRESS_VALUE"
  ParameterKey=TemporalPort,ParameterValue="$TEMPORAL_PORT_VALUE"
  ParameterKey=TemporalIngressCidr,ParameterValue="$TEMPORAL_INGRESS_CIDR_VALUE"
)
