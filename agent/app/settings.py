...
class Settings:
    ...
    worker_stall_repeat_heartbeats: int = int(os.environ.get("WORKER_STALL_REPEAT_HEARTBEATS", "18"))
    worker_running_stall_seconds: int = int(os.environ.get("WORKER_RUNNING_STALL_SECONDS", "900"))
    worker_preflight_stall_seconds: int = int(os.environ.get("WORKER_PREFLIGHT_STALL_SECONDS", "300"))
